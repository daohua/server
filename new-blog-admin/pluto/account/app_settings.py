class AppSettings(object):
    ...
    # Use the overall setting for "AUTH_USER_MODEL"
    @property
    def USER_MODEL(self):
        from django.conf import settings
    ...
    def ADAPTER(self):
        return self._setting('ADAPTER',
                             'account.adapter.DefaultAccountAdapter')
    ...
    def LOGIN_REDIRECT_URL(self):
        return self._setting('LOGIN_REDIRECT_URL', '/account/profile')

    @property
    def LOGOUT_REDIRECT_URL(self):
        return self._setting('LOGOUT_REDIRECT_URL', '/account/login')
